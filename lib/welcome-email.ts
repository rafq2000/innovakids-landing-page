...
export function buildWelcomeEmailHtml({
  ...
  const partialPaymentBlock = isPartial ? `
      <div style="background:#FEF3C7;border:2px solid #F59E0B;border-radius:12px;padding:24px;margin:0 0 24px;">
        ...
        <p style="color:#78350F;font-size:14px;margin:0 0 12px;line-height:1.6;">
          ...
          <strong>Cohorte Junio 2026</strong>, debes completar el pago restante de <strong>$240 USD</strong>
          antes de la semana del 29 de junio.
        </p>
  ...
  const confirmationText = isPartial
    ? `Tu reserva de <strong>$${amount} USD</strong> ha sido recibida. Tu cupo est&aacute; separado en la <strong>Cohorte Junio 2026</strong> del Programa Vibe Explorer de InnovaKids.`
    : `Tu pago ha sido confirmado exitosamente. Ya eres parte de la <strong>Cohorte Junio 2026</strong> del Programa Vibe Explorer de InnovaKids.`
      ...
      <table style="width:100%;border-collapse:collapse;">
        ...
        ${isPartial ? `<tr>
          ...
          <td style="padding:12px 16px;border-bottom:1px solid #eee;">
            ...
            <span style="color:#666;font-size:14px;">Paga los $240 USD restantes antes de la semana del 29 de junio.</span>
          </td>
        </tr>` : ""}
        <tr>
          <td style="padding:12px 16px;border-bottom:1px solid #eee;vertical-align:top;">
          ...
          <td style="padding:12px 16px;border-bottom:1px solid #eee;">
            ...
            <span style="color:#666;font-size:14px;">Lee los documentos antes de la semana del 29 de junio.</span>
          </td>
        </tr>
        <tr>
