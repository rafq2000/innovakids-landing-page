        ...
        >
          <div className="holographic-card p-6 text-center">
            <div className="relative z-10">
              ...
              <p className="premium-gradient-text text-4xl font-black font-premium">Semana del 27 de Abril del 2026</p>
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4 mb-10">
                <div className="bg-white/[0.03] rounded-2xl p-5 border border-white/10 flex items-start gap-4 hover:border-primary/30 transition-colors">
                  ...
                  <div className="flex-grow">
                    <div className="flex items-center justify-between flex-wrap gap-2">
                      ...
                      <span className="text-gray-500 line-through text-lg">$497 USD</span>
                    </div>
                ...
                >
                  ...
                  <p className="premium-gradient-text text-5xl font-black mb-2 font-premium">$297 USD</p>
