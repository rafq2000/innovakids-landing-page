                    ...
                    <div className="max-w-[1100px] mx-auto px-6 md:px-10">
                        ...
                        <div className="grid md:grid-cols-12 gap-10 md:gap-16 items-end">
                            <div className="md:col-span-8">
                                ...
                                >
                                    Creación de <em className="italic text-[#B5522F]">videojuegos</em> con IA.
                                </h1>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <article className="bg-[#FAF7EF] border border-[#1A1714]/12 p-10">
                                ...
                                <ul className="space-y-3 text-[#1A1714]/85 mb-8 text-sm">
                                    <li className="flex gap-3"><span className="text-[#B5522F]">→</span> Vibe Coding · introducción a la lógica</li>
                                    <li className="flex gap-3"><span className="text-[#B5522F]">→</span> Generación de assets de juego con IA</li>
                                    <li className="flex gap-3"><span className="text-[#B5522F]">→</span> Prompt engineering para código</li>
                                </ul>
                                <Link
