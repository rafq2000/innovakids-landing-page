...
export const metadata: Metadata = {
  ...
  description:
    "Aprovecha las vacaciones en Ecuador para que tu hijo aprenda Inteligencia Artificial creando apps, videojuegos y arte. 5 semanas, 10 clases en vivo. Clases 1 a 1. 1ª clase gratis.",
  alternates: {
