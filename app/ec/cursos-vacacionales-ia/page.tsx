...
export const metadata: Metadata = {
  title: "Cursos Vacacionales de IA para Niños en Ecuador (8-17 años) | InnovaKids",
  description:
    "Aprovecha las vacaciones en Ecuador para que tu hijo aprenda Inteligencia Artificial creando apps, videojuegos y arte. 5 semanas, 10 clases en vivo. Grupos de máx 5 alumnos. 1ª clase gratis.",
  alternates: {
    canonical: "https://www.innovakidslatam.com/ec/cursos-vacacionales-ia",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Cursos Vacacionales de IA para Niños en Ecuador | InnovaKids",
    description:
      "Tu hijo crea apps, videojuegos y música con IA en estas vacaciones. 10 clases en vivo, grupos reducidos. 1ª clase gratis.",
    url: "https://www.innovakidslatam.com/ec/cursos-vacacionales-ia",
    siteName: "InnovaKids",
    locale: "es_EC",
    type: "website",
  },
...
export default function CursosVacacionalesEcuadorPage() {
  return (
    <>
      <Navigation />
      <main className="min-h-screen bg-[var(--paper)] text-[#2F2F2C]">
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto text-center bg-gradient-to-br from-[#2F2F2C] to-[#1a1510] text-white rounded-b-3xl">
          <p className="text-[#C96342] font-semibold uppercase tracking-wider text-sm mb-4">
            Vacaciones Sierra (jul-ago) y Costa (feb-mar)
          </p>
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-6">
            Cursos Vacacionales de Inteligencia Artificial para Niños en Ecuador
          </h1>
          <p className="text-lg sm:text-xl text-white/80 max-w-3xl mx-auto mb-8">
            ...
            en Quito, Guayaquil, Cuenca y todo Ecuador ya confían en InnovaKids.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="https://wa.me/56964754219?text=Hola%2C%20quiero%20info%20sobre%20el%20curso%20vacacional%20de%20IA%20en%20Ecuador"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
          ...
          <p className="text-[#5A5751] text-center max-w-3xl mx-auto mb-10">
            En Ecuador, las vacaciones de la Sierra (julio-agosto) y de la Costa (febrero-marzo) son
            la oportunidad perfecta para que tu hijo desarrolle habilidades que lo prepararán para el
            futuro. No es solo entretenimiento: es educación que transforma.
          </p>
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              "Crea un portfolio profesional que puede mostrar a su colegio",
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto bg-white/5 rounded-2xl">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              ...
              { title: "100% online y en vivo", desc: "Solo necesita un computador con internet. Desde Quito, Guayaquil o cualquier ciudad." },
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto text-center">
          ...
          <div className="bg-white/5 border border-[#C96342]/30 rounded-2xl p-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="https://wa.me/56964754219?text=Hola%2C%20quiero%20reservar%20el%20curso%20vacacional%20de%20IA%20para%20mi%20hijo%20en%20Ecuador"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 border border-green-500 text-green-400 hover:bg-green-500/10 font-bold py-3 px-8 rounded-lg transition-colors"
              >
        ...
        <section className="py-12 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto text-center">
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              Ver todo sobre InnovaKids en Ecuador
            </Link>
            <Link
              href="/ec/blog/cursos-inteligencia-artificial-ninos-ecuador-guia"
              className="text-[#B5522F] hover:text-[#C96342] underline underline-offset-4 transition-colors"
            >
              Leer guía completa de cursos de IA en Ecuador
            </Link>
          </div>
        </section>
        <Footer />
