    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Curso de IA para Niños en Quito - InnovaKids",
      },
    ],
  },
}
      ...
      <main className="min-h-screen bg-[var(--paper)] text-[#2F2F2C]">
        ...
        <section className="relative py-20 md:py-28 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-6">
              ...
              <span className="text-[#B5522F]">Quito</span>
            </h1>
            <p className="text-lg md:text-xl text-[#5A5751] max-w-2xl mx-auto mb-8">
              En la capital ecuatoriana, cuna de la Escuela Politécnica Nacional (EPN) y la
              Universidad San Francisco de Quito (USFQ), tus hijos aprenden a crear apps,
              videojuegos y arte con IA. Clases 100&nbsp;% online y en vivo, ideales para el
              régimen Sierra.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="https://wa.me/56964754219?text=Hola%2C%20quiero%20info%20del%20curso%20de%20IA%20para%20mi%20hijo%20en%20Quito"
                target="_blank"
        ...
        <section className="py-16 px-4 bg-[#2F2F2C]/[0.04]">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-10">
              ¿Por qué familias en Quito eligen InnovaKids?
            </h2>
            <div className="grid md:grid-cols-2 gap-6">
              {[
                {
                  title: "Tradición politécnica",
                  text: "Quito alberga la EPN y la USFQ, dos referentes en ciencia y tecnología. Nuestro curso conecta a tus hijos con esa cultura de innovación desde temprano.",
                },
                {
                  title: "Horarios régimen Sierra",
                ...
                {
                  title: "Proyectos reales con IA",
                  text: "En 5 semanas crean apps, videojuegos, arte digital y chatbots. Proyectos que pueden mostrar en ferias escolares de Quito.",
                },
              ].map((item) => (
                <div
                  key={item.title}
        ...
        <section className="py-16 px-4 bg-[#2F2F2C]/[0.04]">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">
              Inversión para familias en Quito
            </h2>
            <p className="text-[#5A5751] mb-2">
              Ecuador usa dólar, así que pagas directo sin conversión.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="https://wa.me/56964754219?text=Hola%2C%20quiero%20inscribir%20a%20mi%20hijo%20en%20Quito"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 border border-[#C96342]/20 text-[#B5522F] hover:bg-[#C96342]/10 font-semibold py-3 px-8 rounded-lg transition-colors"
              >
        ...
        <section className="py-12 px-4">
          <div className="max-w-2xl mx-auto text-center text-sm text-[#5A5751]">
            <p>
              ...
              ·{" "}
              <Link href="/ec/guayaquil" className="text-[#B5522F] hover:underline">
                Curso IA Guayaquil
              </Link>{" "}
              ·{" "}
