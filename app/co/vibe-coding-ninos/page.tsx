...
export const metadata: Metadata = {
  ...
  description:
    "Vibe Coding para niños en Colombia: tu hijo crea apps, videojuegos y chatbots hablando con la IA. Clases en vivo, 1 a 1 (8-17 años). Desde $1.245.000 COP. Clase gratis.",
  alternates: {
