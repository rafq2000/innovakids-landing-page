...
export const metadata: Metadata = {
  ...
  description:
    "Tu hijo en Medellín crea apps, videojuegos y arte con Inteligencia Artificial. Clases en vivo, máx 5 alumnos (8-17 años). 1ª clase gratis. Aprox. $1.245.000 COP.",
  alternates: {
