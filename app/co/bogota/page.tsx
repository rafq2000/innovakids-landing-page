...
export const metadata: Metadata = {
  title: "Curso de IA para Niños en Bogotá — Clases Online | InnovaKids",
  description:
    "Tu hijo en Bogotá crea apps, videojuegos y arte con Inteligencia Artificial. Clases en vivo, máx 5 alumnos (8-17 años). 1ª clase gratis. Aprox. $1.120.000 COP.",
  alternates: {
    canonical: "https://www.innovakidslatam.com/co/bogota",
  },
  robots: {
    index: true,
    follow: true,
        ...
        <section className="relative py-20 md:py-28 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-6">
              ...
              <span className="text-[#B5522F]">Bogotá</span>
            </h1>
            <p className="text-lg md:text-xl text-[#5A5751] max-w-2xl mx-auto mb-8">
              Niños y adolescentes bogotanos (8-17 años) aprenden a crear videojuegos, apps y proyectos
              reales con IA. Clases en vivo con máximo 5 alumnos. 100% online — tu hijo participa
              desde cualquier localidad de Bogotá.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="https://wa.me/56964754219?text=Hola%2C%20quiero%20info%20del%20curso%20de%20IA%20para%20mi%20hijo%20en%20Bogot%C3%A1"
                target="_blank"
        ...
        <section className="py-16 px-4 bg-[#2F2F2C]/[0.04]">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-10">
              ¿Por qué los niños en Bogotá necesitan aprender IA?
            </h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-[#2F2F2C]/5 rounded-xl p-6 border border-[#C96342]/20">
                <Target className="w-8 h-8 text-[#B5522F] mb-3" />
                <h3 className="font-semibold text-lg mb-2">Capital de la innovación colombiana</h3>
                <p className="text-[#5A5751]">
                  Bogotá alberga el MinTIC, Rappi, y el ecosistema tech más grande de Colombia.
                  Las universidades de los Andes y la Javeriana lideran la investigación en IA.
                  Tu hijo puede ser parte de esta revolución.
                </p>
              </div>
              <div className="bg-[#2F2F2C]/5 rounded-xl p-6 border border-[#C96342]/20">
                <Target className="w-8 h-8 text-[#B5522F] mb-3" />
                <h3 className="font-semibold text-lg mb-2">Hub de startups y tecnología</h3>
                <p className="text-[#5A5751]">
                  Con más de 1.500 startups activas, Bogotá es el Silicon Valley colombiano.
                  Empresas como Platzi, Rappi y Frubana nacieron aquí. Los niños que aprenden
                  IA hoy serán los fundadores de mañana.
                </p>
              </div>
              <div className="bg-[#2F2F2C]/5 rounded-xl p-6 border border-[#C96342]/20">
                <Target className="w-8 h-8 text-[#B5522F] mb-3" />
                <h3 className="font-semibold text-lg mb-2">Educación de clase mundial</h3>
                <p className="text-[#5A5751]">
                  Los colegios de Bogotá — desde el Gimnasio Moderno hasta el San Carlos — buscan
                  complementar su currículo con tecnología. InnovaKids es el complemento perfecto
                  como actividad extraescolar.
                </p>
              </div>
              <div className="bg-[#2F2F2C]/5 rounded-xl p-6 border border-[#C96342]/20">
                <Target className="w-8 h-8 text-[#B5522F] mb-3" />
                <h3 className="font-semibold text-lg mb-2">100% online, sin trancones</h3>
                <p className="text-[#5A5751]">
                  Olvídate de la movilidad en Bogotá. Tu hijo aprende desde Chapinero, Usaquén,
                  Suba, Kennedy o cualquier localidad. Solo necesita un computador y conexión
                  a internet.
                </p>
              </div>
            </div>
        ...
        <section className="py-16 px-4 bg-[#2F2F2C]/[0.04]">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-6">
              Inversión para familias en Bogotá
            </h2>
