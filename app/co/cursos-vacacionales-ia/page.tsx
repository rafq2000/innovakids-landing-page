...
export const metadata: Metadata = {
  ...
  description:
    "Aprovecha las vacaciones (junio-julio o diciembre-enero) para que tu hijo aprenda Inteligencia Artificial creando apps, videojuegos y arte. 5 semanas, 10 clases en vivo. Máx 5 alumnos. 1ª clase gratis.",
  alternates: {
      ...
      <main className="min-h-screen bg-[var(--paper)] text-[#2F2F2C]">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto text-center">
          ...
          <div className="bg-white/5 border border-[#C96342]/30 rounded-2xl p-8">
            ...
            <p className="text-lg text-[#5A5751] mb-1">aprox. $1.120.000 COP</p>
