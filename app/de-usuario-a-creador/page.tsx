...
export const metadata: Metadata = {
  ...
  description:
    "Tu hijo pasa de consumidor a creador de tecnología con IA. Método para niños 8-17 años probado por 745 familias, clases 1 a 1 en vivo. Clase gratis.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Tu hijo deja de solo consumir tecnología: aprende a crear con IA. 745 familias, clases 1 a 1 en vivo. Reserva tu clase gratis.",
  ...
  twitter: {
    ...
    title: "De Usuario a Creador de IA · Niños 8-17 años | InnovaKids",
    description:
      "Tu hijo deja de solo consumir tecnología. Aprende a crear con IA. 745 familias, clases 1 a 1. Clase gratis.",
        ...
        <div className="container mx-auto px-6 lg:px-12 max-w-5xl">
          <div className="bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20 rounded-3xl p-16 text-center space-y-10">
            ...
            <p className="text-2xl text-gray-300 max-w-3xl mx-auto">
              Las plazas se agotan rápido para el grupo que inicia el 10 de agosto del 2026. No dejes que siga siendo solo un usuario
              más.
            </p>
