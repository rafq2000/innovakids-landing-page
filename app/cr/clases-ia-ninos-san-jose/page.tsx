...
export const metadata: Metadata = {
  ...
  description:
    "¿Vives en San José? Tu hijo puede crear apps y videojuegos con IA desde casa (Escazú, Santa Ana, Heredia). Horarios flexibles tardes y sábados. Garantía 10 días.total.",
  keywords: [
