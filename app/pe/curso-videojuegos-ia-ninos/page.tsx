...
export const metadata: Metadata = {
  ...
  description:
    "Tu hijo crea videojuegos reales con Inteligencia Artificial en Perú. Plataformas, aventuras y puzzles con Cursor, Replit y ChatGPT. Clases en vivo, máx 5 alumnos. 1ª clase gratis.",
  alternates: {
