...
export const metadata: Metadata = {
  ...
  description:
    "Tu hijo en Arequipa crea apps, videojuegos y proyectos reales con IA. Clases en vivo, 1 a 1 (8-17 años). La UNSA y la segunda ciudad del Perú apuestan por la tecnología. 1.ª clase gratis.",
  alternates: {
  ...
  openGraph: {
    title: "Curso de IA para Niños en Arequipa | InnovaKids",
    description:
      "Niños y adolescentes en Arequipa aprenden a crear tecnología real con IA. Clases 1 a 1, en vivo.",
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                },
                {
                  ...
                  text: "Atención 100% personalizada: el profesor está enfocado solo en tu hijo, conoce su nombre, ritmo e intereses.",
                },
                {
