...
export default function CursoIANinos812PE() {
  return (
    <>
      <Navigation />
        ...
        <section className="relative py-20 px-4 text-center bg-gradient-to-b from-[#2F2F2C] to-[#1a1510] text-white">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="https://wa.me/56964754219?text=Hola%2C%20quiero%20info%20del%20curso%20de%20IA%20para%20niños%20de%208-12%20en%20Perú"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <section className="py-20 px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              ...
              <a
                href="https://wa.me/56964754219?text=Hola%2C%20quiero%20inscribir%20a%20mi%20hijo%20de%208-12%20en%20el%20curso%20de%20IA%20(Perú)"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 border border-green-500 text-green-400 hover:bg-green-500/10 font-bold py-3 px-8 rounded-xl transition-colors"
              >
            ...
            <p className="text-[#5A5751] text-sm">
              Familias en Lima, Arequipa, Trujillo, Cusco y todo Perú ya aprenden con InnovaKids.
            </p>
            <Link href="/pe" className="inline-block mt-6 text-[#B5522F] hover:text-[#9A4428] text-sm underline underline-offset-4">
              Ver todos los cursos en Perú
            </Link>
          </div>
        </section>
        <Footer />
