...
export const metadata: Metadata = {
  ...
  description:
    "Vibe Coding para niños en Perú: tu hijo crea apps, videojuegos y chatbots hablando con la IA. Clases en vivo, 1 a 1 (8-17 años). Desde S/ 1.100 PEN. Clase gratis.",
  alternates: {
