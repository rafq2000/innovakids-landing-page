...
export const metadata: Metadata = {
  ...
  description:
    "Vibe Coding para niños en Perú: tu hijo crea apps, videojuegos y chatbots hablando con la IA. Clases en vivo, grupos de 5 (8-17 años). Desde S/ 1.000 PEN. Clase gratis.",
  alternates: {
    canonical: "https://www.innovakidslatam.com/pe/vibe-coding-ninos",
  },
...
export default function VibeCodingPeruPage() {
  return (
    <>
      <Navigation />
        ...
        <section className="py-16 px-4 bg-gradient-to-b from-[#2F2F2C] to-[#1a1510]">
          <div className="container mx-auto max-w-5xl text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
              Vibe Coding para Niños en Perú:{" "}
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white p-8 rounded-2xl border border-[#E8E4DE] shadow-sm">
                ...
                <p className="text-[#5A5751]">
                  ...
                  dominen Vibe Coding hoy tendrán una ventaja competitiva enorme en el mercado laboral peruano y global.
                </p>
              </div>
              <div className="bg-white p-8 rounded-2xl border border-[#E8E4DE] shadow-sm">
          ...
          <div className="container mx-auto max-w-3xl text-center">
            <div className="bg-gradient-to-b from-[#2F2F2C] to-[#1a1510] p-12 rounded-3xl">
              ...
              <p className="text-xl text-gray-300 mb-4">
                Programa completo de 5 semanas por <strong className="text-white">$267 USD (aprox. S/ 1.000 PEN)</strong>.
                Familias en Lima, Arequipa, Trujillo y todo Perú ya aprenden con nosotros.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="https://wa.me/56964754219?text=Hola%2C%20quiero%20info%20sobre%20Vibe%20Coding%20para%20niños%20en%20Perú" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center border-2 border-green-500 text-green-400 hover:bg-green-500/10 font-bold text-lg px-10 py-4 rounded-lg transition-colors">
        ...
        <section className="py-8 px-4">
          <div className="container mx-auto max-w-4xl">
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              <Link href="/pe" className="text-[#B5522F] hover:text-[#C96342] underline">
                InnovaKids Perú
              </Link>
