...
function buildReminderEmailHtml(studentName: string, parentEmail: string, reminderNumber: number) {
  ...
  const urgencyText = reminderNumber <= 1
    ? "Para confirmar su lugar en la <strong>Cohorte Agosto 2026</strong>, necesitamos que completes el pago restante de <strong>$240 USD</strong>."
    : reminderNumber === 2
      ? "Este es tu segundo recordatorio. El programa inicia la semana del 10 de agosto y a&uacute;n falta completar el pago de <strong>$240 USD</strong>."
