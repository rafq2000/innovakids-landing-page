    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Curso de IA para Chicos en Córdoba - InnovaKids",
      },
    ],
  },
}
      ...
      <main className="min-h-screen bg-[var(--paper)] text-[#2F2F2C]">
        ...
        <section className="relative py-20 md:py-28 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-6">
              ...
              <span className="text-[#B5522F]">Córdoba</span>
            </h1>
            <p className="text-lg md:text-xl text-[#5A5751] max-w-2xl mx-auto mb-8">
              Córdoba es el Silicon Valley argentino: sede de la Universidad Nacional de
              Córdoba (UNC), oficinas de Globant, Mercado Libre y un ecosistema tech en
              plena expansión. Tus chicos aprenden a crear apps, videojuegos y arte con IA
              en clases 100&nbsp;% online y en vivo.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="https://wa.me/56964754219?text=Hola%2C%20quiero%20info%20del%20curso%20de%20IA%20para%20mi%20hijo%20en%20C%C3%B3rdoba"
                target="_blank"
        ...
        <section className="py-16 px-4 bg-[#2F2F2C]/[0.04]">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-10">
              ¿Por qué familias en Córdoba eligen InnovaKids?
            </h2>
            <div className="grid md:grid-cols-2 gap-6">
              {[
                {
                  title: "El Silicon Valley argentino",
                  text: "Córdoba es el polo tech más importante del interior de Argentina. Globant, Mercado Libre y decenas de startups nacieron o crecieron acá. Tu hijo se conecta con ese ADN innovador.",
                },
                {
                  title: "Tradición UNC",
                ...
                },
                {
                  ...
                  text: "Crean apps funcionales, videojuegos, arte con IA y chatbots. Ideal para ferias escolares y concursos tech de Córdoba.",
                },
              ].map((item) => (
                <div
                  key={item.title}
        ...
        <section className="py-16 px-4 bg-[#2F2F2C]/[0.04]">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">
              Inversión para familias en Córdoba
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="https://wa.me/56964754219?text=Hola%2C%20quiero%20inscribir%20a%20mi%20hijo%20en%20C%C3%B3rdoba"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 border border-[#C96342]/20 text-[#B5522F] hover:bg-[#C96342]/10 font-semibold py-3 px-8 rounded-lg transition-colors"
              >
        ...
        <section className="py-12 px-4">
          <div className="max-w-2xl mx-auto text-center text-sm text-[#5A5751]">
            <p>
              ...
              ·{" "}
              <Link href="/ar/buenos-aires" className="text-[#B5522F] hover:underline">
                Curso IA Buenos Aires
              </Link>{" "}
              ·{" "}
              <Link
