...
export const metadata: Metadata = {
  title: "Curso de Videojuegos con IA para Chicos en Argentina (8-17) | InnovaKids",
  description:
    "Tu hijo crea videojuegos reales con Inteligencia Artificial en Argentina. Plataformas, aventuras y puzzles con Cursor, Replit y ChatGPT. Clases en vivo, máx 5 alumnos. 1ª clase gratis.",
  alternates: {
    canonical: "https://www.innovakidslatam.com/ar/curso-videojuegos-ia-ninos",
  },
  robots: { index: true, follow: true },
}

export default function CursoVideojuegosIAArgentina() {
  return (
    <>
      <Navigation />
      <main className="min-h-screen bg-[var(--paper)] text-[#2F2F2C]">
        ...
        <section className="relative py-20 px-4 text-center bg-gradient-to-br from-[#2F2F2C] to-[#1a1510] text-white">
          <div className="max-w-4xl mx-auto">
            <p className="text-[#B5522F] font-semibold mb-4 tracking-wide uppercase text-sm">
              Curso online en vivo para chicos y adolescentes en Argentina
            </p>
            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
              Curso de Creación de <span className="text-[#B5522F]">Videojuegos con IA</span> para Chicos en Argentina
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="https://wa.me/56964754219?text=Hola%2C%20quiero%20info%20del%20curso%20de%20videojuegos%20con%20IA%20para%20mi%20hijo%20en%20Argentina"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <section className="py-16 px-4 max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-4">
            ...
            ¿Qué videojuegos va a crear tu hijo?
          </h2>
        ...
        <section className="py-16 px-4 bg-white/[0.02]">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-10">Herramientas profesionales que va a usar</h2>
            <div className="grid md:grid-cols-3 gap-6">
              {[
        ...
        <section className="py-12 px-4 text-center">
          <Link href="/ar" className="text-[#B5522F] hover:text-[#C96342] underline text-lg">
            <ArrowRight className="inline mr-1 w-4 h-4" />
            Ver todos los cursos de InnovaKids en Argentina
          </Link>
        </section>
        <Footer />
      </main>
