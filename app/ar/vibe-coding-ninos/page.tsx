...
export const metadata: Metadata = {
  ...
  description:
    "Vibe Coding para chicos en Argentina: tu hijo crea apps, videojuegos y chatbots hablando con la IA. Clases en vivo, 1 a 1 (8-17 años). Desde $317.000 ARS. Clase gratis.",
  alternates: {
  ...
  openGraph: {
    ...
    url: "https://www.innovakidslatam.com/ar/vibe-coding-ninos",
    siteName: "InnovaKids",
    type: "website",
    locale: "es_AR",
  },
...
export default function VibeCodingArgentinaPage() {
  return (
    <>
      <Navigation />
        ...
        <section className="py-16 px-4 bg-gradient-to-b from-[#2F2F2C] to-[#1a1510]">
          <div className="container mx-auto max-w-5xl text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
              Vibe Coding para Chicos en Argentina:{" "}
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="bg-white p-8 md:p-12 rounded-2xl border border-[#E8E4DE] shadow-sm space-y-6">
              ...
              <p className="text-lg text-[#5A5751] leading-relaxed">
                ...
                <strong className="text-[#2F2F2C]"> elevar la creatividad</strong>: los chicos se enfocan en qué construir, no en cómo escribir punto y coma.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white p-8 rounded-2xl border border-[#E8E4DE] shadow-sm">
                ...
                <p className="text-[#5A5751]">
                  Gartner predice que el 75% del software se creará con asistencia de IA para 2028. Los chicos que
                  dominen Vibe Coding hoy tendrán una ventaja competitiva enorme en el mercado laboral argentino y global.
                </p>
              </div>
              <div className="bg-white p-8 rounded-2xl border border-[#E8E4DE] shadow-sm">
                ...
                <p className="text-[#5A5751]">
                  Con programación tradicional, un chico tarda semanas en crear algo funcional. Con Vibe Coding,
          ...
          <div className="container mx-auto max-w-3xl text-center">
            <div className="bg-gradient-to-b from-[#2F2F2C] to-[#1a1510] p-12 rounded-3xl">
              ...
              <p className="text-gray-400 mb-8">
                Agendá una clase gratis. Sin experiencia previa necesaria.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="https://wa.me/56964754219?text=Hola%2C%20quiero%20info%20sobre%20Vibe%20Coding%20para%20chicos%20en%20Argentina" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center border-2 border-green-500 text-green-400 hover:bg-green-500/10 font-bold text-lg px-10 py-4 rounded-lg transition-colors">
        ...
        <section className="py-8 px-4">
          <div className="container mx-auto max-w-4xl">
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              <Link href="/ar" className="text-[#B5522F] hover:text-[#C96342] underline">
