...
export const metadata: Metadata = {
  title: "Curso de IA para Chicos de 8 a 12 Años en Argentina | InnovaKids",
  description:
  ...
  alternates: {
    canonical: "https://www.innovakidslatam.com/ar/curso-ia-ninos-8-12",
  },
  robots: { index: true, follow: true },
}

export default function CursoIANinos812AR() {
  return (
    <>
      <Navigation />
      <main className="min-h-screen bg-[var(--paper)] text-[#2F2F2C]">
        ...
        <section className="relative py-20 px-4 text-center bg-gradient-to-b from-[#2F2F2C] to-[#1a1510] text-white">
          <div className="max-w-4xl mx-auto">
            <span className="inline-block mb-4 px-4 py-1.5 rounded-full bg-[#C96342]/10 text-[#B5522F] text-sm font-medium border border-[#C96342]/20">
              Chicos de 8 a 12 años — Aprox. $285.000 ARS ($267 USD)
            </span>
            <h1 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">
              Curso de Inteligencia Artificial para Chicos de 8 a 12 Años en Argentina
            </h1>
            <p className="text-lg md:text-xl text-[#5A5751] mb-8 max-w-3xl mx-auto">
              La edad perfecta para arrancar. Tu hijo descubre la IA creando proyectos reales —arte, música, juegos y su primer chatbot— en un entorno seguro, en vivo y 100% en español.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="https://wa.me/56964754219?text=Hola%2C%20quiero%20info%20del%20curso%20de%20IA%20para%20chicos%20de%208-12%20en%20Argentina"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold mb-8 text-center">
              ...
              ¿Por qué 8 a 12 años es la MEJOR edad para arrancar con IA?
            </h2>
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                { title: "Sin miedo al error", desc: "A diferencia de los adolescentes, los chicos de esta edad prueban sin vergüenza. Ese «atreverse» es el superpoder que acelera el aprendizaje." },
              ].map((item) => (
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              {[
                ...
                "Grupos reducidos de máximo 5 chicos: control total del entorno de aprendizaje.",
        ...
        <section className="py-20 px-4 text-center">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Inscribilo hoy</h2>
            <p className="text-[#5A5751] mb-2">
              Programa completo: <span className="text-[#2F2F2C] font-bold">$267 USD (aprox. $285.000 ARS)</span>
            </p>
            <p className="text-[#5A5751] mb-8 text-sm">Reservá con $27 USD (aprox. $29.000 ARS). Solo pagás el resto después de las 2 primeras clases.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              ...
              <a
                href="https://wa.me/56964754219?text=Hola%2C%20quiero%20inscribir%20a%20mi%20hijo%20de%208-12%20en%20el%20curso%20de%20IA%20(Argentina)"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 border border-green-500 text-green-400 hover:bg-green-500/10 font-bold py-3 px-8 rounded-xl transition-colors"
              >
            ...
            <p className="text-[#5A5751] text-sm">
              Familias en Buenos Aires, Córdoba, Rosario, Mendoza y toda Argentina ya aprenden con InnovaKids.
            </p>
            <Link href="/ar" className="inline-block mt-6 text-[#B5522F] hover:text-[#9A4428] text-sm underline underline-offset-4">
              Ver todos los cursos en Argentina
            </Link>
          </div>
        </section>
        <Footer />
