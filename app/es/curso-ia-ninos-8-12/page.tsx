...
export const metadata: Metadata = {
  ...
  description:
    "Tu hijo de 8 a 12 años crea arte, música, mini-juegos y su primer chatbot con Inteligencia Artificial. Extraescolar online en vivo, 1 a 1. No necesita saber programar. 1ª clase gratis.",
  alternates: {
