...
export const metadata: Metadata = {
  title: "Extraescolar de IA para Niños de 8 a 12 Años en España | InnovaKids",
  description:
    "Tu hijo de 8 a 12 años crea arte, música, mini-juegos y su primer chatbot con Inteligencia Artificial. Extraescolar online en vivo, grupos de máx 5 alumnos. No necesita saber programar. 1ª clase gratis.",
  alternates: {
    canonical: "https://www.innovakidslatam.com/es/curso-ia-ninos-8-12",
  },
  robots: { index: true, follow: true },
}

export default function CursoIANinos812ES() {
  return (
    <>
      <Navigation />
        ...
        <section className="relative py-20 px-4 text-center bg-gradient-to-b from-[#2F2F2C] to-[#1a1510] text-white">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="https://wa.me/56964754219?text=Hola%2C%20quiero%20info%20de%20la%20extraescolar%20de%20IA%20para%20niños%20de%208-12%20en%20España"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              {[
                ...
                "Proyectos visuales y creativos: cada clase termina con algo que puede enseñar a su familia.",
        ...
        <section className="py-20 px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              ...
              <a
                href="https://wa.me/56964754219?text=Hola%2C%20quiero%20inscribir%20a%20mi%20hijo%20de%208-12%20en%20la%20extraescolar%20de%20IA%20(España)"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 border border-green-500 text-green-400 hover:bg-green-500/10 font-bold py-3 px-8 rounded-xl transition-colors"
              >
            ...
            <p className="text-[#5A5751] text-sm">
              Familias en Madrid, Barcelona, Valencia, Sevilla y toda España ya aprenden con InnovaKids.
            </p>
            <Link href="/es" className="inline-block mt-6 text-[#B5522F] hover:text-[#9A4428] text-sm underline underline-offset-4">
              Ver todos los cursos en España
            </Link>
          </div>
        </section>
        <Footer />
