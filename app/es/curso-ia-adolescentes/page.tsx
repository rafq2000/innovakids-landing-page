...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "curso ia adolescentes barcelona",
    "inteligencia artificial para jóvenes españa",
    "extraescolar tecnología adolescentes",
    "preparación selectividad tecnología",
    "carreras tech adolescentes españa",
  ],
  alternates: {
    canonical: "https://www.innovakidslatam.com/es/curso-ia-adolescentes",
  },
  openGraph: {
    title: "Curso de IA para Adolescentes (13-17) en España | InnovaKids",
    description:
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: "Adolescentes españoles creando proyectos con IA - InnovaKids",
    }],
  },
...
const benefits = [
  {
    icon: Target,
    title: "Ventaja para selectividad y carreras tech",
    desc: "Tu hijo llega a la universidad con un portafolio de proyectos reales creados con IA. Diferencial clave para acceder a carreras de ingeniería, informática o diseño digital.",
  },
  {
    icon: CheckCircle,
  ...
  {
    icon: ArrowRight,
    title: "Primer empleo tech y emprendimiento",
    desc: "Aprende habilidades que las empresas tech en Madrid, Barcelona y toda Europa buscan hoy. Construye su primer MVP con metodología Silicon Valley.",
  },
]

const projects = [
  "App funcional publicada con IA",
  "Portafolio digital para acceso universitario",
  "Startup MVP con metodología Silicon Valley",
  "Shorts y contenido visual con IA generativa",
  "Certificado digital verificable",
]

export default function CursoIAAdolescentesEspanaPage() {
  const courseSchema = {
    "@context": "https://schema.org",
    "@type": "Course",
    name: "Curso de IA para Adolescentes en España | InnovaKids",
    description: "Extraescolar de inteligencia artificial para adolescentes de 13 a 17 años en España. Apps reales, portafolio y proyectos con IA.",
    url: "https://www.innovakidslatam.com/es/curso-ia-adolescentes",
    ...
    inLanguage: "es",
    courseMode: "online",
    offers: { "@type": "Offer", price: "245", priceCurrency: "EUR", availability: "https://schema.org/InStock" },
  }
      ...
      <main className="min-h-screen">
        ...
        <section className="relative bg-[#1A1714] text-[#FAF7EF] overflow-hidden">
          ...
          <div className="relative z-10 max-w-[1280px] mx-auto px-6 md:px-10 pt-28 md:pt-36 pb-20 md:pb-28">
            <p className="font-mono-accent text-[10px] uppercase tracking-[0.28em] text-[#B5522F] font-semibold mb-6">
              Adolescentes 13-17 años · España
            </p>

            <h1 className="font-display text-[40px] sm:text-[56px] md:text-[72px] leading-[0.94] tracking-[-0.03em] text-[#FAF7EF] max-w-[18ch] mb-8">
              La extraescolar de IA que{" "}
              <em className="italic text-[#B5522F]" style={{ fontVariationSettings: '"opsz" 144, "SOFT" 100' }}>prepara</em>{" "}
              a tu hijo para el futuro.
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center mb-8">
              ...
              <a
                href="https://wa.me/56964754219?text=Hola%2C%20quiero%20info%20del%20curso%20de%20IA%20para%20adolescentes%20en%20Espa%C3%B1a"
                target="_blank"
        ...
        <section className="bg-[#FAF7EF] text-[#1A1714] py-20 md:py-28">
          <div className="max-w-[1100px] mx-auto px-6 md:px-10">
            <h2 className="font-display text-3xl sm:text-4xl md:text-5xl leading-[0.96] tracking-[-0.03em] mb-14 max-w-[20ch]">
              ¿Por qué esta{" "}
              <em className="italic text-[#B5522F]" style={{ fontVariationSettings: '"opsz" 144, "SOFT" 100' }}>extraescolar</em>?
            </h2>
        ...
        <section className="bg-[#FAF7EF] text-[#1A1714] py-12 border-t border-[#1A1714]/10">
          <div className="max-w-[1100px] mx-auto px-6 md:px-10 text-center">
            <Link href="/es" className="inline-flex items-center gap-2 text-[#B5522F] hover:text-[#9A4428] font-semibold transition-colors">
              <ArrowRight className="w-4 h-4 rotate-180" />
              Volver a InnovaKids España
            </Link>
          </div>
        </section>
