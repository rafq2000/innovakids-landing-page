...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Curso Inteligencia Artificial Niños Colombia | Vibe Coding",
    description: "Transforma a tu hijo en un creador digital. El curso de IA más avanzado de Colombia para niños de 8-17 años.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Curso de IA para niños de 8-17 años en Colombia. 10 clases en vivo, grupos de máximo 5 niños, garantía 10 días.",
            provider: {
              "@type": "Organization",
              name: "InnovaKids",
