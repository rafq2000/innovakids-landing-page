        ...
        <article className="py-16 md:py-24">
          <div className="container mx-auto max-w-4xl px-4">
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p>
                Las clases con 20 o 30 niños no funcionan para enseñar habilidades técnicas. Buscá cursos con clases
                ...
                <table className="w-full text-left text-sm">
                  ...
                  <tbody>
                    <tr className="border-t">
                      ...
                      <td className="p-4 font-bold text-[#0038A8]">1 a 1 (individual)</td>
            ...
            <div className="my-12 rounded-3xl bg-gradient-to-br from-[#0038A8] to-[#001d53] p-8 text-center text-white">
              ...
              <p className="mt-4 text-sm text-white/60">$297 USD (₲ 2.200.000) · 10 clases · Clases 1 a 1 · Garantía de 10 días</p>
            </div>
