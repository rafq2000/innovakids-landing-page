...
export const metadata: Metadata = {
  ...
  description:
    "Vibe Coding para niños 8-17 años: crea apps, videojuegos y música hablando con la IA. Clases en vivo 1 a 1, 745 graduados. Clase gratis.",
  keywords: [
    "vibe coding niños",
  ...
  openGraph: {
    ...
    description:
      "Tu hijo pasa de consumidor a creador: construye apps y juegos hablando con la IA. Clases 1 a 1 en vivo, 745 graduados. Clase gratis.",
  ...
  twitter: {
    ...
    title: "Vibe Coding para Niños 8-17 años · 2026 | InnovaKids",
    description:
      "Crea apps y videojuegos hablando con la IA. Clases 1 a 1 en vivo, 745 graduados. Clase gratis.",
