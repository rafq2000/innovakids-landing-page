        ...
        <article className="py-16 md:py-24">
          <div className="container mx-auto max-w-4xl px-4">
                ...
                <table className="w-full text-left text-sm">
                  ...
                  <tbody>
                    <tr className="border-t">
                      ...
                      <td className="p-4 font-bold text-[#0073CF]">1 a 1 (individual)</td>
            ...
            <div className="my-12 rounded-3xl bg-gradient-to-br from-[#0073CF] to-[#00247D] p-8 text-center text-white">
              ...
              <p className="mt-4 text-sm text-white/60">$297 USD (aprox L 7,300) · 10 clases · Clases 1 a 1 · Garantía de 10 días</p>
            </div>
