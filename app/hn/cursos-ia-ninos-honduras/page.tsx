...
export const metadata: Metadata = {
  title: "Curso Inteligencia Artificial Niños y Adolescentes Honduras | Vibe Coding",
  description:
  ...
  openGraph: {
    title: "Curso Inteligencia Artificial Niños y Adolescentes Honduras | Vibe Coding",
    description: "Transforma a tu hijo en un creador digital. El curso de IA más avanzado de Honduras para niños de 8-17 años.",
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="mx-auto max-w-4xl text-3xl font-bold leading-tight tracking-tight md:text-6xl lg:text-7xl px-2">
                ...
                <span className="block text-2xl md:text-4xl mt-4 text-white/90">Para Niños en Honduras</span>
              </h1>
              ...
              <div className="bg-[#0073CF]/10 border border-[#0073CF]/20 rounded-2xl p-6 max-w-xl mx-auto">
                <p className="text-lg font-semibold text-[#0073CF]">💰 Inversión: $267 USD</p>
