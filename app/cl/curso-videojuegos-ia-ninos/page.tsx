...
export const metadata: Metadata = {
  title: "Curso de Videojuegos con IA para Niños en Chile (8-17) | InnovaKids",
  description:
    "Tu hijo crea videojuegos reales con Inteligencia Artificial en Chile. Plataformas, aventuras y puzzles con Cursor, Replit y ChatGPT. Clases en vivo, máx 5 alumnos. 1ª clase gratis.",
  alternates: {
    canonical: "https://www.innovakidslatam.com/cl/curso-videojuegos-ia-ninos",
  },
  robots: { index: true, follow: true },
}

export default function CursoVideojuegosIAChile() {
  return (
    <>
      <Navigation />
      <main className="min-h-screen bg-[var(--paper)] text-[#2F2F2C]">
        ...
        <section className="relative py-20 px-4 text-center bg-gradient-to-br from-[#2F2F2C] to-[#1a1510] text-white">
          <div className="max-w-4xl mx-auto">
            <p className="text-[#B5522F] font-semibold mb-4 tracking-wide uppercase text-sm">
              Curso online en vivo para niños y adolescentes en Chile
            </p>
            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
              Curso de Creación de <span className="text-[#B5522F]">Videojuegos con IA</span> para Niños en Chile
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="https://wa.me/56964754219?text=Hola%2C%20quiero%20info%20del%20curso%20de%20videojuegos%20con%20IA%20para%20mi%20hijo%20en%20Chile"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <section className="py-16 px-4 bg-gradient-to-b from-[#2F2F2C] to-[#1a1510] text-white">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="bg-white/5 border border-[#C96342]/30 rounded-2xl p-8 mb-8">
              ...
              <p className="text-white/60">aprox. $278.000 CLP</p>
              <p className="text-white/50 text-sm mt-2">Reserva con $27 USD (aprox. $25.000 CLP). Solo pagas el resto después de las 2 primeras clases.</p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="https://calendly.com/innovakidslatam/clase-gratis"
        ...
        <section className="py-12 px-4 text-center">
          <Link href="/cl" className="text-[#B5522F] hover:text-[#C96342] underline text-lg">
            <ArrowRight className="inline mr-1 w-4 h-4" />
            Ver todos los cursos de InnovaKids en Chile
          </Link>
        </section>
        <Footer />
      </main>
