...
export const metadata: Metadata = {
  title: "Cursos Vacacionales de IA para Niños en Chile (8-17 años) | InnovaKids",
  description:
    "Aprovecha las vacaciones de verano (diciembre a febrero) para que tu hijo aprenda Inteligencia Artificial creando apps, videojuegos y arte. 5 semanas, 10 clases en vivo. 1 a 1. 1ª clase gratis.",
  alternates: {
    canonical: "https://www.innovakidslatam.com/cl/cursos-vacacionales-ia",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: "Cursos Vacacionales de IA para Niños en Chile | InnovaKids",
    description:
      "Tu hijo crea apps, videojuegos y música con IA en estas vacaciones de verano. 10 clases en vivo, 1 a 1. 1ª clase gratis.",
    url: "https://www.innovakidslatam.com/cl/cursos-vacacionales-ia",
    siteName: "InnovaKids",
    locale: "es_CL",
    type: "website",
  },
...
export default function CursosVacacionalesChilePage() {
  return (
    <>
      <Navigation />
      <main className="min-h-screen bg-[var(--paper)] text-[#2F2F2C]">
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto text-center bg-gradient-to-br from-[#2F2F2C] to-[#1a1510] text-white rounded-b-3xl">
          <p className="text-[#C96342] font-semibold uppercase tracking-wider text-sm mb-4">
            Vacaciones de verano · diciembre - febrero
          </p>
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-6">
            Cursos Vacacionales de Inteligencia Artificial para Niños en Chile
          </h1>
          <p className="text-lg sm:text-xl text-white/80 max-w-3xl mx-auto mb-8">
            ...
            en Santiago, Viña del Mar, Concepción y todo Chile ya confían en InnovaKids.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="https://wa.me/56964754219?text=Hola%2C%20quiero%20info%20sobre%20el%20curso%20vacacional%20de%20IA%20en%20Chile"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
          ...
          <p className="text-[#5A5751] text-center max-w-3xl mx-auto mb-10">
            Las vacaciones de verano en Chile (diciembre a febrero) son las más largas del año: más de
            10 semanas sin clases. En vez de que tu hijo pase ese tiempo solo consumiendo contenido,
            puede aprender a crearlo. No es solo entretenimiento: es educación que transforma.
          </p>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto bg-white/5 rounded-2xl">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              ...
              { title: "100% online y en vivo", desc: "Solo necesita un computador con internet. Desde Santiago, Viña del Mar o cualquier ciudad." },
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto text-center">
          ...
          <p className="text-[#5A5751] mb-8">
            Precio accesible para familias chilenas. Paga con tarjeta o PayPal.
          </p>
          <div className="bg-white/5 border border-[#C96342]/30 rounded-2xl p-8">
            ...
            <p className="text-lg text-[#5A5751] mb-1">aprox. $278.000 CLP</p>
            <p className="text-[#5A5751] mb-1">10 clases en vivo · 5 semanas · 1 a 1</p>
            <p className="text-sm text-[#5A5751] mb-6">Reserva con solo $27 USD (aprox. $25.000 CLP). Pagas el resto después de las 2 primeras clases.</p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="https://wa.me/56964754219?text=Hola%2C%20quiero%20reservar%20el%20curso%20vacacional%20de%20IA%20para%20mi%20hijo%20en%20Chile"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 border border-green-500 text-green-400 hover:bg-green-500/10 font-bold py-3 px-8 rounded-lg transition-colors"
              >
        ...
        <section className="py-12 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto text-center">
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              Ver todo sobre InnovaKids en Chile
            </Link>
            <Link
              href="/cl/blog/cursos-inteligencia-artificial-ninos-chile-guia"
              className="text-[#B5522F] hover:text-[#C96342] underline underline-offset-4 transition-colors"
            >
              Leer guía completa de cursos de IA en Chile
            </Link>
          </div>
        </section>
        <Footer />
