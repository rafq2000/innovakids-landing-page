...
export const metadata: Metadata = {
  ...
  description:
    "Aprovecha las vacaciones de verano (diciembre a febrero) para que tu hijo aprenda Inteligencia Artificial creando apps, videojuegos y arte. 5 semanas, 10 clases en vivo. Máx 5 alumnos. 1ª clase gratis.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Tu hijo crea apps, videojuegos y música con IA en estas vacaciones de verano. 10 clases en vivo, grupos reducidos. 1ª clase gratis.",
