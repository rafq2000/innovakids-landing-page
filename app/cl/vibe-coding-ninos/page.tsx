...
export const metadata: Metadata = {
  ...
  description:
    "Vibe Coding para niños en Chile: tu hijo crea apps, videojuegos y chatbots hablando con la IA. Clases en vivo, 1 a 1 (8-17 años). Desde $278.000 CLP. Clase gratis.",
  alternates: {
  ...
  openGraph: {
    ...
    url: "https://www.innovakidslatam.com/cl/vibe-coding-ninos",
    siteName: "InnovaKids",
    type: "website",
    locale: "es_CL",
  },
...
export default function VibeCodingChilePage() {
  return (
    <>
      <Navigation />
        ...
        <section className="py-16 px-4 bg-gradient-to-b from-[#2F2F2C] to-[#1a1510]">
          <div className="container mx-auto max-w-5xl text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
              Vibe Coding para Niños en Chile:{" "}
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white p-8 rounded-2xl border border-[#E8E4DE] shadow-sm">
                ...
                <p className="text-[#5A5751]">
                  ...
                  dominen Vibe Coding hoy tendrán una ventaja competitiva enorme en el mercado laboral chileno y global.
                </p>
              </div>
              <div className="bg-white p-8 rounded-2xl border border-[#E8E4DE] shadow-sm">
          ...
          <div className="container mx-auto max-w-3xl text-center">
            <div className="bg-gradient-to-b from-[#2F2F2C] to-[#1a1510] p-12 rounded-3xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="https://wa.me/56964754219?text=Hola%2C%20quiero%20info%20sobre%20Vibe%20Coding%20para%20niños%20en%20Chile" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center border-2 border-green-500 text-green-400 hover:bg-green-500/10 font-bold text-lg px-10 py-4 rounded-lg transition-colors">
        ...
        <section className="py-8 px-4">
          <div className="container mx-auto max-w-4xl">
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              <Link href="/cl" className="text-[#B5522F] hover:text-[#C96342] underline">
                InnovaKids Chile
              </Link>
