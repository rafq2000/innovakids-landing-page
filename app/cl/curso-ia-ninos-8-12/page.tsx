...
export const metadata: Metadata = {
  title: "Curso de IA para Niños de 8 a 12 Años en Chile | InnovaKids",
  description:
  ...
  alternates: {
    canonical: "https://www.innovakidslatam.com/cl/curso-ia-ninos-8-12",
  },
  robots: { index: true, follow: true },
}

export default function CursoIANinos812CL() {
  return (
    <>
      <Navigation />
        ...
        <section className="relative py-20 px-4 text-center bg-gradient-to-b from-[#2F2F2C] to-[#1a1510] text-white">
          <div className="max-w-4xl mx-auto">
            <span className="inline-block mb-4 px-4 py-1.5 rounded-full bg-[#C96342]/10 text-[#B5522F] text-sm font-medium border border-[#C96342]/20">
              Niños de 8 a 12 años — Aprox. $278.000 CLP ($297 USD)
            </span>
            <h1 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">
              Curso de Inteligencia Artificial para Niños de 8 a 12 Años en Chile
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="https://wa.me/56964754219?text=Hola%2C%20quiero%20info%20del%20curso%20de%20IA%20para%20niños%20de%208-12%20en%20Chile"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <section className="py-20 px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-[#5A5751] mb-2">
              Programa completo: <span className="text-[#2F2F2C] font-bold">$297 USD (aprox. $278.000 CLP)</span>
            </p>
            <p className="text-[#5A5751] mb-8 text-sm">Reserva con $27 USD (aprox. $25.000 CLP). Solo pagas el resto después de las 2 primeras clases.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              ...
              <a
                href="https://wa.me/56964754219?text=Hola%2C%20quiero%20inscribir%20a%20mi%20hijo%20de%208-12%20en%20el%20curso%20de%20IA%20(Chile)"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 border border-green-500 text-green-400 hover:bg-green-500/10 font-bold py-3 px-8 rounded-xl transition-colors"
              >
            ...
            <p className="text-[#5A5751] text-sm">
              Familias en Santiago, Viña del Mar, Valparaíso, Concepción y todo Chile ya aprenden con InnovaKids.
            </p>
            <Link href="/cl" className="inline-block mt-6 text-[#B5522F] hover:text-[#9A4428] text-sm underline underline-offset-4">
              Ver todos los cursos en Chile
            </Link>
          </div>
        </section>
        <Footer />
