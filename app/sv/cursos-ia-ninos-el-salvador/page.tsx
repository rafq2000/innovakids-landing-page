...
export const metadata: Metadata = {
  title: "Curso Inteligencia Artificial Niños y Adolescentes El Salvador | Vibe Coding",
  description:
  ...
  keywords: [
    "curso inteligencia artificial niños el salvador",
    "cursos de tecnologia para niños el salvador",
    "aprender ia san salvador",
    "innovakids cursos",
  ],
  openGraph: {
    title: "Curso Inteligencia Artificial Niños y Adolescentes El Salvador | Vibe Coding",
    description: "Transforma a tu hijo en un creador digital. El curso de IA más avanzado de El Salvador para niños de 8-17 años.",
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="bg-[#0F47AF]/10 border border-[#0F47AF]/20 rounded-2xl p-6 max-w-xl mx-auto">
                <p className="text-lg font-semibold text-[#0F47AF]">💰 Inversión: $267 USD</p>
