...
export const metadata: Metadata = {
  title: "Curso de IA para Niños en Monterrey — Clases Online | InnovaKids",
  description:
    "Tu hijo en Monterrey crea apps, videojuegos y arte con Inteligencia Artificial. Clases en vivo, máx 5 alumnos (8-17 años). 1ª clase gratis. Aprox. $5,400 MXN.",
  alternates: {
    canonical: "https://www.innovakidslatam.com/mx/monterrey",
  },
  robots: {
    index: true,
    follow: true,
        ...
        <section className="relative py-20 md:py-28 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-6">
              ...
              <span className="text-[#B5522F]">Monterrey</span>
            </h1>
            <p className="text-lg md:text-xl text-[#5A5751] max-w-2xl mx-auto mb-8">
              Niños y adolescentes regios (8-17 años) aprenden a crear videojuegos, apps y proyectos
              reales con IA. Clases en vivo con máximo 5 alumnos. 100% online — tu hijo participa
              desde cualquier colonia del área metropolitana de Monterrey.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="https://wa.me/56964754219?text=Hola%2C%20quiero%20info%20del%20curso%20de%20IA%20para%20mi%20hijo%20en%20Monterrey"
                target="_blank"
        ...
        <section className="py-16 px-4 bg-[#2F2F2C]/[0.04]">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-10">
              ¿Por qué los niños en Monterrey necesitan aprender IA?
            </h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-[#2F2F2C]/5 rounded-xl p-6 border border-[#C96342]/20">
                <Target className="w-8 h-8 text-[#B5522F] mb-3" />
                <h3 className="font-semibold text-lg mb-2">Tec de Monterrey: referente global</h3>
                <p className="text-[#5A5751]">
                  El Tecnológico de Monterrey es una de las mejores universidades de Latinoamérica
                  en tecnología e innovación. Tu hijo puede empezar su camino hacia carreras STEM
                  aprendiendo IA desde los 8 años.
                </p>
              </div>
              <div className="bg-[#2F2F2C]/5 rounded-xl p-6 border border-[#C96342]/20">
                <Target className="w-8 h-8 text-[#B5522F] mb-3" />
                <h3 className="font-semibold text-lg mb-2">Capital industrial y del nearshoring</h3>
                <p className="text-[#5A5751]">
                  Monterrey lidera la revolución del nearshoring en México. Tesla, KIA y cientos de
                  empresas tech se instalan aquí. La demanda de talento en IA crecerá exponencialmente
                  y tu hijo puede prepararse desde ahora.
                </p>
              </div>
              <div className="bg-[#2F2F2C]/5 rounded-xl p-6 border border-[#C96342]/20">
                <Target className="w-8 h-8 text-[#B5522F] mb-3" />
                <h3 className="font-semibold text-lg mb-2">Hub tech del norte de México</h3>
                <p className="text-[#5A5751]">
                  Con empresas como Softtek, NEORIS y Axtel, Monterrey es el centro tecnológico
                  del norte mexicano. El ecosistema emprendedor regio es uno de los más dinámicos
                  del país.
                </p>
              </div>
              <div className="bg-[#2F2F2C]/5 rounded-xl p-6 border border-[#C96342]/20">
                <Target className="w-8 h-8 text-[#B5522F] mb-3" />
                <h3 className="font-semibold text-lg mb-2">Online desde toda el área metro</h3>
                <p className="text-[#5A5751]">
                  Las clases son 100% online — tu hijo participa desde San Pedro Garza García,
                  Santa Catarina, Apodaca, Guadalupe o cualquier colonia del área metropolitana.
        ...
        <section className="py-16 px-4 bg-[#2F2F2C]/[0.04]">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-6">
              Inversión para familias en Monterrey
            </h2>
