...
export const metadata: Metadata = {
  ...
  description:
    "Tu hijo crea videojuegos reales con Inteligencia Artificial en México. Plataformas, aventuras y puzzles con Cursor, Replit y ChatGPT. Clases en vivo, 1 a 1. 1ª clase gratis.",
  alternates: {
