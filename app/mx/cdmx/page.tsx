...
export const metadata: Metadata = {
  ...
  description:
    "Tu hijo en Ciudad de México crea apps, videojuegos y arte con Inteligencia Artificial. Clases en vivo, máx 5 alumnos (8-17 años). 1ª clase gratis. Aprox. $5,400 MXN.",
  alternates: {
