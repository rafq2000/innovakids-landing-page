...
const testimonials = [
  {
    ...
    content:
      "Antes del curso, Tomás pasaba 3 horas al día en YouTube y Roblox sin aprender nada útil. Después de solo 3 semanas en InnovaKids, creó su primera app funcional. Los $297 mejor invertidos de mi vida.",
    rating: 5,
    hasVideo: true,
  },
  {
