...
export const faqs = [
    ...
    // 4. LOGISTICS (¿Cómo funciona?) -> Time Delay ↓
    {
        ...
        answer:
            "Iniciamos la semana del 30 de Marzo del 2026. Los horarios son 100% flexibles: al agendar tu evaluación elegimos juntos el bloque que mejor se adapte a tu rutina escolar (tenemos opciones de Lunes a Sábado, mañanas y tardes).",
    },
    {
