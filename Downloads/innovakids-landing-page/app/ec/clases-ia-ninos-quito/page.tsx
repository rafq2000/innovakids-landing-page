...
export const metadata: Metadata = {
  ...
  description:
    "¿Vives en Quito? Tu hijo puede crear apps y videojuegos con IA desde casa (Cumbayá, Valle de los Chillos). Horarios flexibles tardes y sábados. Garantía 10 días.total.",
  keywords: [
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="bg-[#0033A0]/10 rounded-2xl p-6 max-w-xl mx-auto">
                <p className="text-lg font-semibold text-[#0033A0]">💰 $267 USD - 10 Clases</p>
