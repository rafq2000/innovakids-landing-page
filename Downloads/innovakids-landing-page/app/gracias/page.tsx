                            ...
                            <aside className="lg:col-span-5 border border-[#1A1714]/12 p-8 bg-[#F2EDE0]/40">
                                ...
                                <ol className="border-t border-[#1A1714]/12">
                                    {[
                                        ...
                                        { k: "Selecciona tus horarios", v: "Elige mínimo 3 días con 2 horarios. Es obligatorio para asignarte grupo.", href: "/mis-horarios" },
                                        { k: "Escríbenos por WhatsApp", v: "Al +56 9 2245 0492 para confirmar tu inscripción.", href: "https://wa.me/56922450492?text=Hola%2C%20acabo%20de%20inscribirme" },
                                    ].map((item, i) => (
                                        <li
                                            key={item.k}
