        ...
        <div className="container mx-auto px-6 lg:px-12 max-w-7xl">
          <div className="text-center space-y-12 max-w-5xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center pt-8">
              ...
              <p className="text-sm text-gray-500">Solo 5 cupos disponibles • Inicio Semana del 27 de Abril del 2026</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-32">
        <div className="container mx-auto px-6 lg:px-12 max-w-5xl">
          <div className="bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20 rounded-3xl p-16 text-center space-y-10">
            ...
            <p className="text-2xl text-gray-300 max-w-3xl mx-auto">
              Quedan cupos limitados para el programa que inicia la Semana del 27 de Abril del 2026.
            </p>
