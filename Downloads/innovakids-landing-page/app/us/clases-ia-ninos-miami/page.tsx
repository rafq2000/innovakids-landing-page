...
export const metadata: Metadata = {
  ...
  description:
    "¿Vives en Miami? Tu hijo puede crear apps y videojuegos con IA mientras refuerza su español (Doral, Weston, Brickell). Horarios flexibles. Garantía 10 días.total.",
  keywords: [
      ...
      <main className="min-h-screen bg-background">
        ...
        <section className="py-20" id="precio">
          <div className="container mx-auto px-4 text-center">
            <h2 className="mb-4 text-3xl font-bold">Inversión: $267 USD</h2>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              offers: { "@type": "Offer", price: "267", priceCurrency: "USD" },
              inLanguage: "es",
            }),
          }}
        />
