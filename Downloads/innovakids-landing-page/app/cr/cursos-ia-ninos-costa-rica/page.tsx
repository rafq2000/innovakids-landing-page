...
export const metadata: Metadata = {
  title: "Curso Inteligencia Artificial Niños y Adolescentes Costa Rica | Vibe Coding",
  description:
  ...
  openGraph: {
    title: "Curso Inteligencia Artificial Niños y Adolescentes Costa Rica | Vibe Coding",
    description: "Transforma a tu hijo en un creador digital. El curso de IA más avanzado de Costa Rica para niños de 8-17 años.",
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="mx-auto max-w-4xl text-3xl font-bold leading-tight tracking-tight md:text-6xl lg:text-7xl px-2">
                ...
                <span className="block text-2xl md:text-4xl mt-4 text-white/90">Para Niños en Costa Rica</span>
              </h1>
