...
export const metadata: Metadata = {
  ...
  description:
    "El mejor curso de Inteligencia Artificial para niños y adolescentes (8-17). Tu hijo crea proyectos reales con IA en 5 semanas. Grupos de 5 alumnos. Inicio semana del 8 de junio.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Tu hijo crea música, arte, historias y proyectos reales con IA en 5 semanas. 10 clases en vivo, grupos de 5. Inicio semana del 8 de junio.",
  ...
  twitter: {
    ...
    description: "Tu hijo crea con IA en 5 semanas. Grupos de 5. Inicio semana del 8 de junio.",
        ...
        <section className="py-16 md:py-20 px-4">
          <div className="container mx-auto max-w-3xl">
            ...
            <p className="text-muted-foreground mb-10">
              Inicio: semana del 8 de junio · Sábados y miércoles · Término: 8 de julio de 2026
            </p>
        ...
        <section className="py-16 px-4 bg-muted/30 border-t">
          <div className="container mx-auto max-w-2xl text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Inicio semana del 8 de junio · Las plazas se agotan rápido · Solo 5 alumnos por grupo
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
