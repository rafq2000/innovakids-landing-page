...
const tools = [
  {
    ...
    description: "Calcula tu sueldo líquido a partir del bruto con leyes sociales",
    icon: <Calculator className="h-8 w-8" />,
    href: "/calculadora-sueldo-liquido",
    category: "Calculadoras",
    color: "bg-gradient-to-br from-emerald-700 via-emerald-600 to-emerald-700",
    borderColor: "border-emerald-600/30",
    hoverColor: "hover:from-emerald-600 hover:via-emerald-500 hover:to-emerald-600",
  ...
  },
  {
    id: "feriado",
    title: "Feriado Legal",
    description: "Calcula cuánto te deben por vacaciones proporcionales",
    icon: <Calculator className="h-8 w-8" />,
    href: "/calculators/feriado-legal",
    category: "Calculadoras",
    color: "bg-gradient-to-br from-blue-600 via-blue-500 to-blue-600",
    borderColor: "border-blue-500/30",
    hoverColor: "hover:from-blue-500 hover:via-blue-400 hover:to-blue-500",
    iconBg: "bg-blue-700/50",
    popular: false,
  },
  {
    id: "reajuste",
    title: "Reajuste Pensión",
    description: "Calcula el reajuste de la pensión alimenticia según IPC",
    icon: <Calculator className="h-8 w-8" />,
    href: "/calculators/reajuste-pension",
    category: "Calculadoras",
    color: "bg-gradient-to-br from-rose-600 via-rose-500 to-rose-600",
    borderColor: "border-rose-500/30",
    hoverColor: "hover:from-rose-500 hover:via-rose-400 hover:to-rose-500",
    iconBg: "bg-rose-700/50",
    popular: false,
  },
  {
    id: "embargo",
    title: "Embargo de Sueldo",
    description: "Descubre el límite legal de retención de tu salario",
    icon: <Calculator className="h-8 w-8" />,
    href: "/calculators/embargo-sueldo",
    category: "Calculadoras",
    color: "bg-gradient-to-br from-red-600 via-red-500 to-red-600",
    borderColor: "border-red-500/30",
    hoverColor: "hover:from-red-500 hover:via-red-400 hover:to-red-500",
  ...
  },
  {
    ...
    description: "Generador automático de cartas de renuncia válidas",
    icon: <FileSignature className="h-8 w-8" />,
    href: "/carta-de-renuncia",
    category: "Documentos",
    color: "bg-gradient-to-br from-orange-600 via-orange-500 to-orange-600",
    borderColor: "border-orange-500/30",
    hoverColor: "hover:from-orange-500 hover:via-orange-400 hover:to-orange-500",
